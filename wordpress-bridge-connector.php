...
function wpbc_render_settings_page() {
    ...
    $current_key = get_option('bridge_api_key', '');
    ...
    <div class="wrap">
        ...
        <div class="card" style="max-width: 800px; margin-top: 20px;">
            ...
            <ol style="line-height: 2;">
                <li>Gehe zu deinem <strong>WP Maintenance Monitor Dashboard</strong></li>
                <li>Füge diese WordPress-Installation als neue Seite hinzu</li>
                <li>Kopiere den generierten <strong>API-Key</strong></li>
                <li>Füge den Key oben in das Feld ein und klicke auf "Speichern"</li>
                <li>Fertig! Deine Seite kann jetzt zentral verwaltet werden</li>
            </ol>
        </div>
...
add_action('admin_notices', function() {
    $api_key = get_option('bridge_api_key', '');
